...
# Change ownership
sudo chown -R www-data:www-data /var/www/mirror.nekoha/ || { echo "Failed to change ownership"; exit 1; }

# Set permissions
sudo chmod -R 755 /var/www/mirror.nekoha/ || { echo "Failed to set permissions"; exit 1; }
