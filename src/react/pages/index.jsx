      ...
      <div className="container py-4 px-3 mx-auto">
        <div className="row mb-4 d-flex justify-content-between">
          ...
          <div className="col-12 col-lg-7 align-self-center text-center text-lg-start">
            ...
            <p>
              Nekoha is an osu! beatmap mirror that stores all osu! Beatmaps,
              though not all yet, but it's growing. Download Beatmaps or fetch
              their data with <span className="text-secondary">no ratelimit</span>.
            </p>
          </div>
        </div>
          ...
          <div className="row g-2 justify-content-center">
            ...
            <div className="col-12 col-md-auto">
              <a
                ...
                href="https://discord.gg/QNCmZBqwBQ"
                target="_blank"
            ...
            <div className="col-12 col-md-auto">
              <a
                ...
                href="https://github.com/mirror-nekoha-moe/mirror-server/blob/master/README.MD"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaGithub />
                      ...
                      <div className="d-flex justify-content-between align-items-center">
                        <div>
                          <p className="h3 mb-0 text-secondary">
                            {stats.beatmap_count?.toLocaleString() || 0}
                          </p>
                  ...
                  <div className="card h-100">
                    <div className="card-body">
                      ...
                      <div className="d-flex justify-content-between align-items-center">
                        <div>
                          <p className="h3 mb-0 text-secondary">
                            {stats.beatmapset_count?.toLocaleString() || 0}
                          </p>
                  ...
                  <div className="card h-100">
                    <div className="card-body">
                      ...
                      <div className="d-flex justify-content-between align-items-center">
                        <div>
                          <p className="h3 mb-0 text-secondary">
                            {stats.last_beatmapset_id?.toLocaleString() || 0}
                          </p>
                  ...
                  <div className="card h-100">
                    <div className="card-body">
                      <p className="h5 card-title">
                        Missing Beatmapsets by Status
                      </p>
                      <div className="row g-2 mt-2">
                        {[
                          {
                            key: "missing_beatmapsets_ranked",
                            label: "Ranked",
                            color: "bg-info",
                          },
                          {
                            key: "missing_beatmapsets_approved",
                            label: "Approved",
                            color: "bg-success",
                          },
                          {
                            key: "missing_beatmapsets_qualified",
                            label: "Qualified",
                            color: "bg-success",
                          },
                          {
                            key: "missing_beatmapsets_loved",
                            label: "Loved",
                            color: "cbg-pink-2",
                          },
                          {
                            key: "missing_beatmapsets_pending",
                            label: "Pending",
                            color: "cbg-dark-grey",
                          },
                          {
                            key: "missing_beatmapsets_wip",
                            label: "WIP",
                            color: "cbg-dark-grey",
                          },
                          {
                            key: "missing_beatmapsets_graveyard",
                            label: "Graveyard",
                            color: "cbg-dark-grey",
                          },
                        ].map(
                          (status) =>
                            stats[status.key] !== undefined && (
                              <div key={status.key} className="col">
                                <div
                                  className={`counter-item ${status.color} d-flex justify-content-between align-items-center p-2`}
                                >
                                  <span className="card-property-title">
                                    {status.label}
                                  </span>
                                  <span
                                    className={`badge cbg-black-t40 rounded-pill`}
                                  >
                        ...
                        <small className="text-muted">
                          Missing Beatmapsets due to disabled download, DMCA or
                          ratelimit (KEKW)
                        </small>
                        <br />
                        <small className="text-warning mt-0">
                          Total: {stats.missing_beatmapsets}
                        </small>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="card-body">
                      ...
                      <div className="row g-2 mt-2">
                        {[
                          {
                            key: "ranked_count",
                            missingKey: "missing_beatmapsets_ranked",
                            label: "Ranked",
                            color: "bg-info",
                          },
                          {
                            key: "approved_count",
                            missingKey: "missing_beatmapsets_approved",
                            label: "Approved",
                            color: "bg-success",
                          },
                          {
                            key: "qualified_count",
                            missingKey: "missing_beatmapsets_qualified",
                            label: "Qualified",
                            color: "bg-success",
                          },
                          {
                            key: "loved_count",
                            missingKey: "missing_beatmapsets_loved",
                            label: "Loved",
                            color: "cbg-pink-2",
                          },
                          {
                            key: "pending_count",
                            missingKey: "missing_beatmapsets_pending",
                            label: "Pending",
                            color: "cbg-dark-grey",
                          },
                          {
                            key: "wip_count",
                            missingKey: "missing_beatmapsets_wip",
                            label: "WIP",
                            color: "cbg-dark-grey",
                          },
                          {
                            key: "graveyard_count",
                            missingKey: "missing_beatmapsets_graveyard",
                            label: "Graveyard",
                            color: "cbg-dark-grey",
                          },
                        ].map((status) => {
                      ...
                      <div className="card-body">
                        ...
                        <div className="row g-2 mt-2">
                          {[
                            ...
                            {
                              suffix: "approved_count",
                              label: "Approved",
                              color: "bg-success",
                            },
                            {
                              suffix: "qualified_count",
                              label: "Qualified",
                              color: "bg-success",
                            },
                            {
                            ...
                            return (
                              val !== undefined && (
                                <div key={key} className="col-12">
                                  <div
                                    className={`counter-item ${s.color} d-flex justify-content-between align-items-center p-2`}
                                  >
                                    <span className="card-property-title">
                                      {s.label}
                                    </span>
